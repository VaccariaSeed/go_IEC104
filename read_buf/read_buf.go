...
// IrregularInt16 处理不是特定长度的int16,就是长度可能是3，可能是1，然后将结果转成int16
...
// IrregularInt32 处理不是特定长度的int32,就是长度可能是3，可能是5，然后将结果转成int32
...
// IrregularInt64 处理不是特定长度的int64,就是长度可能是3，可能是5，然后将结果转成int64
...
// IrregularUint16 处理不是特定长度的Uint16,就是长度可能是3，可能是5，然后将结果转成int16
...
// IrregularUint32 处理不是特定长度的Uint32,就是长度可能是3，可能是5，然后将结果转成int32
...
// IrregularUint64 处理不是特定长度的Uint64,就是长度可能是3，可能是5，然后将结果转成int64
