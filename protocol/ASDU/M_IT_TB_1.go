...
func init() {
	bindASDUStore(TypeCode_M_IT_TB_1, func() ASDUer {
		return New_M_IT_TB_1()
	})
}

func New_M_IT_TB_1() *M_IT_TB_1 {
	return &M_IT_TB_1{asduCap: &asduCap{}}
}

// M_IT_TB_1 带 CP56Time2a 时标的累计量
type M_IT_TB_1 struct {
	*asduCap
	bcrSlice []*object.BCR        //二进制计数器读数
	tsSlice  []*object.CP56Time2a //七个八位位组二进制时间
}

func (m *M_IT_TB_1) BindItem(addr uint32, counter int32, sq, cy, ca, iv byte, ts time.Time) {
...
func (m *M_IT_TB_1) ASDUType() *TypeIdentification {
	return Type_M_IT_TB_1
}

func (m *M_IT_TB_1) Decode(sq byte, bf *read_buf.ReadBuf) error {
...
func (m *M_IT_TB_1) ObtainNext() (*object.IOA, *object.BCR, *object.CP56Time2a) {
	index := m.index()
