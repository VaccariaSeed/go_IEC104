...
func init() {
	bindASDUStore(TypeCode_M_EP_TE_1, func() ASDUer {
		return New_M_EP_TE_1()
	})
}

func New_M_EP_TE_1() *M_EP_TE_1 {
	return &M_EP_TE_1{asduCap: &asduCap{}}
}

// M_EP_TE_1 带 CP56Time2a 时标的继电保护设备成组启动事件
type M_EP_TE_1 struct {
	*asduCap
...
func (m *M_EP_TE_1) BindItem(addr uint32, gs, sl1, sl2, sl3, sie, sr, ei, bl, sb, nt, iv byte, elapsedMs uint16, ts time.Time) {
...
func (m *M_EP_TE_1) ASDUType() *TypeIdentification {
	return Type_M_EP_TE_1
}

func (m *M_EP_TE_1) Decode(sq byte, bf *read_buf.ReadBuf) error {
	...
	if err == nil {
		for i := range itemSlice[0] {
			...
			m.tsSlice = append(m.tsSlice, itemSlice[3][i].(*object.CP56Time2a))
		}
	}
	return err
}

func (m *M_EP_TE_1) Encode(sq byte) (frame []byte, err error) {
...
func (m *M_EP_TE_1) model() []object.Objector {
...
func (m *M_EP_TE_1) ObtainNext() (*object.IOA, *object.SPE, *object.QDP, *object.CP16Time2a, *object.CP56Time2a) {
	index := m.index()
